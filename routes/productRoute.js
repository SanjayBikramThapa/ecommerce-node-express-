...
const { postProduct, productList, productDetails, updateProduct,deleteProduct, relatedProductList } = require('../database/productController')
...
router.get('/product/related/:id',relatedProductList)
